...
//    public static final String DEFAULT_APPKEY="d6f44e8f1ba9d3dcf4fab7a487fa97dd";//内
    public static final String DEFAULT_APPKEY="c3aaccc217852fd66b8cbd5c8bcb92e9";//外
     ...
     * 存放发送图片的目录
     */
    public static String JTC_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/jtcdemo/image/";
